...
export function QuotationsPage() {
  ...
  // Helper for E-signature status badge
  const getESignBadge = (sigStatus?: string) => {
    switch (sigStatus) {
      case "Signed":
        return (
      ...
      default:
        return (
          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-slate-100 text-slate-600 border border-slate-200/60">
            Not sent
          </span>
        );
    }
  ...
  const getProbabilityInfo = (status: QuotationStatus) => {
    switch (status) {
      case "Accepted":
      case "Invoiced":
  ...
  const getValidUntilSubtext = (item: Quotation) => {
    ...
    if (item.quotationId === "QUO-2025-0004")
      return (
        <span className="text-[11px] font-medium text-amber-600 block mt-0.5">
          30 days left
        </span>
      );
    if (item.quotationId === "QUO-2025-0003")
      return (
        <span className="text-[11px] font-medium text-amber-600 block mt-0.5">
          24 days left
        </span>
      );
    if (item.quotationId === "QUO-2025-0002")
      return (
        <span className="text-[11px] font-medium text-amber-600 block mt-0.5">
          14 days left
        </span>
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-xs flex flex-col justify-between hover:shadow-md transition-shadow">
          ...
          <div className="mt-3">
            ...
            <div className="flex items-center gap-1.5 mt-2 text-xs text-slate-500">
              ...
              <span>{pendingItems.length || 2} Open quote pipeline value</span>
            </div>
          </div>
        </div>

        {/* Card 2: Adopted Quotes */}
        <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-xs flex flex-col justify-between hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold tracking-wider text-slate-500 uppercase">
              ACCEPTED QUOTES
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-xs flex flex-col justify-between hover:shadow-md transition-shadow">
          ...
          <div className="mt-3">
            ...
            <div className="flex items-center gap-1.5 mt-2 text-xs text-slate-500">
              ...
              <span>
                {acceptedCount || 1} of {totalCount || 4} quotes converted
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-xs overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
              <h3 className="text-base font-bold text-slate-900">Quotations</h3>
            </div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50/50 text-[11px] font-bold text-slate-500 uppercase tracking-wider">
                    ...
                    <th className="py-3.5 px-4">E-SIGN</th>
                    ...
                    paginatedData.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* E-Sign Status */}
                          <td className="py-4 px-4 whitespace-nowrap">
                            {getESignBadge(item.signatureStatus)}
                          </td>
                                  ...
                                  <div className="absolute right-0 mt-1 w-44 bg-white border border-slate-200 rounded-xl shadow-lg z-20 py-1 text-xs text-slate-700 text-left">
                                    ...
                                    <button
                                      onClick={() => {
                                        setActiveMenuId(null);
                                        router.push(
                                          `/finance/invoices?quotationId=${item.id}`,
                                        );
                                      }}
                                      className="w-full px-3 py-2 text-left hover:bg-slate-50 flex items-center gap-2"
                                    >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 font-normal">
                      Convert accepted quotes to invoice
                    </p>
                  </div>
                </div>
                <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-purple-600 transition-colors" />
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 font-normal">
                      Track client digital signatures
                    </p>
                  </div>
                </div>
                <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-purple-600 transition-colors" />
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 font-normal">
                      View detailed quote performance
                    </p>
                  </div>
                </div>
                <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-purple-600 transition-colors" />
