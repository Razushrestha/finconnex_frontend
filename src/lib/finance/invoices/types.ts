...
export const invoices: Invoice[] = [
  withMoney({
    ...
    dueDate: "29/07/2026",
    notes: "Generated from QUO-2025-0004.",
    lineItems: [
      {
        id: "ili1",
        productId: "fp1",
        name: "Greystone refinance Invoice",
        quantity: 1,
        unitPrice: 2650,
        taxRate: 10,
      },
  ...
  withMoney({
    ...
    sentAt: "01/05/2026 10:00",
    audit: [
      { id: "a1", at: "01/05/2026 09:00", action: "Created", actor: "Shiva Kadhka" },
      { id: "a2", at: "01/05/2026 10:00", action: "Sent", actor: "Shiva Kadhka" },
  ...
  withMoney({
    id: "inv5",
    invoiceId: "INV-3200",
    title: "Capital commercial contract",
    status: "Paid",
    clientId: "c5",
    clientName: "Metro West Capital",
    contactName: "Alex West",
    contactEmail: "alex@metrowest.example",
    dealName: "Metro West Commercial",
    owner: "John Smith",
    ...
    lineItems: [
      {
        id: "ili6",
        productId: "fp1",
        name: "Capital commercial contract",
        quantity: 1,
        unitPrice: 3818.18,
        taxRate: 10,
      },
    ...
    sentAt: "10/06/2026 09:00",
    audit: [
      { id: "a1", at: "10/06/2026 09:00", action: "Created", actor: "John Smith" },
      { id: "a2", at: "24/06/2026 14:00", action: "Payment recorded $4,200.00", actor: "System" },
    ],
  }),
];
