...
export const payments: Payment[] = [
  {
    ...
    status: "Completed",
    reference: "EFT matched",
    notes: "Greystone refinance",
  ...
  },
  {
    ...
    method: "Card",
    status: "Failed",
    reference: "Declined: Insufficient",
    notes: "Apex overdue settlement",
  ...
  },
  {
    ...
    status: "Completed",
    reference: "Ezidebit",
    notes: "Northside settlement",
    receivedAt: "05/07/2026",
    recordedBy: "Roshna Abraham",
    createdAt: "05/07/2026",
    audit: [
      { id: "a1", at: "05/07/2026 11:00", action: "Recorded", actor: "Roshna Abraham" },
      { id: "a2", at: "05/07/2026 11:01", action: "Marked completed via Direct Debit", actor: "System" },
    ],
  },
];
