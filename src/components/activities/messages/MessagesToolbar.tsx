...
export type MessageView = "list" | "kanban";
...
const tabs = ["All Messages"] as const;
...
export function MessagesToolbar({
  ...
  const [activeTab, setActiveTab] =
    useState<(typeof tabs)[number]>("All Messages");
        ...
        <div className="flex items-center gap-2">
          <div className="flex overflow-hidden rounded-lg bg-indigo-600">
            <button
              ...
              onClick={() =>
                router.push(
                  `/activities/messages/create?layoutid=${DEFAULT_LAYOUT_ID}&redirect=false`,
                )
              }
