...
//     const newPage = Math.floor(firstRowIndex / newSize) + 1;
...
export function PaginationBar({
  ...
  function handlePageSizeChange(e: React.ChangeEvent<HTMLSelectElement>) {
    ...
    // by re-deriving a valid page number for the new size.
    const firstRowIndex = (page - 1) * pageSize;
    const newPage = Math.floor(firstRowIndex / newSize) + 1;
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <select
                ...
                className="h-8 appearance-none rounded-md border border-border bg-background pl-2 pr-7 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-violet-600"
