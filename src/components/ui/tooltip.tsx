    ...
    >
      ...
      {show &&
        ...
        createPortal(
          ...
          >
            <div className="whitespace-nowrap rounded-lg border border-violet-500/35 bg-slate-900 px-2.5 py-1.5 text-xs font-medium leading-snug text-white shadow-xl shadow-slate-900/30 dark:border-violet-500/40 dark:bg-zinc-800">
              {content}
            </div>
            <div
              className={`absolute left-1/2 -translate-x-1/2 h-2.5 w-2.5 rotate-45 border-violet-500/35 bg-slate-900 dark:border-violet-500/40 dark:bg-zinc-800 ${
                coords.placement === "bottom"
                  ? "-top-[5px] border-l border-t"
                  : "-bottom-[5px] border-r border-b"
              }`}
