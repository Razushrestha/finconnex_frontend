        ...
        <div className="grid grid-cols-2 gap-3 xl:grid-cols-4">
          {(
            [
              ...
              { label: "Total Deals", value: data.totals.deals, Icon: Zap },
              { label: "Total Settlements", value: data.totals.settlements, Icon: Trophy },
              { label: "Conversion Rate", value: `${data.totals.conversion}%`, Icon: Wallet },
            ] as const
